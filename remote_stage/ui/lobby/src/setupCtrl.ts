...
export default class SetupController {
  ...
  private readonly loadPropsFromStore = (forceOptions?: ForceSetupOptions) => {
    ...
    this.omokRuleSet = this.propWithApply(storeProps.omokRuleSet || 'taraguchi10');
  ...
  propsToFormData = (color: ColorChoice) =>
    xhr.form({
      ...
      omokRuleSet: this.gameType === 'hook' ? this.omokRuleSet() : undefined,
